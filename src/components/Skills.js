   ...
   return (
      <div className="">
         ...
         <div className="grid grid-cols-2">
            <div className=" py-2 gap-y-0">
               <div
                  onClick={() => setShow(!show)}
                  className=" flex items-center justify-evenly mx-30 my-10 cursor-pointerrounded-full p-2 box-border "
               >
            ...
            <div className=" py-2 gap-y-0">
               <div
                  ...
                  className=" flex items-center justify-evenly mx-30 ml-20 my-10 cursor-pointer rounded-full p-2 box-border "
               >
                  <div className="flex items-center">
                     <FaReact className="text-6xl " />
                     <div className=" ml-2 block items-center">
